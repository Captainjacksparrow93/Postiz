...
if [ ! -f ".env" ]; then
  ...
  echo "    MAIN_URL            – your domain or http://YOUR_VPS_IP:4007"
  echo "    FRONTEND_URL        – same as MAIN_URL"
  echo "    NEXT_PUBLIC_BACKEND_URL – MAIN_URL + /api"
  echo "    JWT_SECRET          – long random string"
  echo "    POSTGRES_PASSWORD   – secure DB password"
  echo ""
